...
public class OldHandlerMapping implements HandlerMapping {
    ...
    @Override
    public Controller getHandler(HttpServletRequest request) { return getHandler(request.getRequestURI()); }
